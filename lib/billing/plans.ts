...
function buildPlan(id: PlanId, env: NodeJS.ProcessEnv, pricing: PlanEnv, hardMax: number): Plan {
  ...
  return {
    ...
    crossBrowserEnabled: boolFromEnv(env, `${P}CROSS_BROWSER`, base.crossBrowserEnabled),
    regressionTesting: boolFromEnv(env, `${P}REGRESSION_TESTING`, base.regressionTesting),
