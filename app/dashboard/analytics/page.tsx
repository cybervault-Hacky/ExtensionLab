...
export default function AnalyticsDashboardPage() {
  return (
    <div className="max-w-4xl space-y-8 p-6">
      ...
      <p className="text-sm text-[var(--text-secondary)]">Real data from ExtensionLab. No fake metrics. Empty states indicate insufficient or no data.</p>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          <div key={s.title} className="rounded-xl border border-[var(--border)] bg-[var(--surface-secondary)] p-5">
      ...
      <div className="rounded-xl border border-[var(--border)] bg-[var(--surface)] p-5">
        ...
        <p className="mt-2 text-xs text-[var(--status-success)]">No synthetic data used.</p>
      </div>
    </div>
  );
}
